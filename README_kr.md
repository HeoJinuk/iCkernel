...
기존 Jupyter C 커널에서는 표준 입력(`scanf`) 사용이 문제가 되는 경우가 많습니다.  
특히 윈도우(Windows) 환경에서는 입력 기능이 원활하게 작동하지 않을 수 있습니다.

**ic-kernel**은 이러한 호환성 문제를 개선하여, OS에 상관없이 표준 입출력을 사용할 수 있도록 제작되었습니다.
...
"✅ Interactive C Kernel installed successfully!" 메시지가 나오면 모든 준비가 끝났습니다.
